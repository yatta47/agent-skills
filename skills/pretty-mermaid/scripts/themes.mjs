...
const CUSTOM_THEMES = ['candy-pop', 'pastel-tech', 'mermaid-live-soft'];
...
async function main() {
  ...
  const themes = [...CUSTOM_THEMES, ...Object.keys(THEMES)];
  ...
  console.log(`\nTotal: ${themes.length} themes (${CUSTOM_THEMES.length} custom)`);
  console.log('\nUsage:');
